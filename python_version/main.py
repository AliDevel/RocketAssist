...
This module wires together the configuration loader, the OpenAI client and the
Rocket.Chat connection to provide a very small but functional chat bot.  The
implementation is intentionally small but mirrors the behaviour of the Go
version closely enough for demonstration purposes."""
...
def main():
    ...
    rocket.connect()
    rocket.login()
    rocket.subscribe_room(cfg.rocketchat.user_id)  # DM room for the bot itself
